        ...
        <section className="flex justify-between gap-4 max-sm:flex-col items-center">
            ...
            <Image src={user.imageUrl} alt={user?.firstName} width={110} height={110} />
              <div className="flex flex-col gap-2">
                  ...
                  <p className="text-sm text-muted-foregroud"> {user.emailAddresses[0].emailAddress}</p>
          ...
          <Accordion type="multiple" >
            ...
            <AccordionItem value="companions">
                 <AccordionTrigger className="text-2xl font-bold">My companion {`(${companions.length})`}</AccordionTrigger>
                 <AccordionContent>
